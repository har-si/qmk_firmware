...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT(
    ...
    KC_Z,     KC_X,     KC_C,    KC_V,    KC_B,          KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,
                                      MO_NAV,  TD(TD_NUM_SYM), KC_SPC, OS_SHFT
  ),
  ...
  [NAV] = LAYOUT(
    ...
    TO_NAV,    OS_MEH,      __x__,    __x__,      CW_TOGG,            MC_UNDO,    KC_TAB,    MC_COPY,   MC_PASTE,   KC_ENT,
  ...
  [NUM] = LAYOUT(
    ...
    TO_NUM,    OS_MEH,    KC_RPRN,    KC_RBRC,    KC_RCBR,             KC_PDOT,    KC_1,    KC_2,      KC_3,     KC_ENT,
                                             KC_TRNS, KC_TRNS,  KC_BSPC, KC_0
  ),


  [FUN] = LAYOUT(
    __x__,     KC_VOLD,   KC_MUTE,    KC_VOLU,    KC_NUM,              KC_PSCR,    KC_F7,    KC_F8,      KC_F9,     KC_F12,
  ...
  [MSE] = LAYOUT(
    __x__,     __x__,    __x__,     __x__,      __x__,                 KC_WH_L,    KC_WH_D,    KC_WH_U,    KC_WH_R,     KC_INS,
    KC_LCTL,   KC_LGUI,     KC_LALT,  KC_LSFT,    KC_ALGR,             KC_MS_L,    KC_MS_D,    KC_MS_U,    KC_MS_R,     KC_APP,
    TO_MSE,     KC_MEH,    __x__,     __x__,      __x__,               KC_BTN3,    KC_ACL0,    KC_ACL1,    KC_ACL2,     KC_DEL,
  ...
  [NAVL] = LAYOUT(
    KC_ESC,    MC_SPTAB,    __x__,    MC_ALTF4,   __x__,              KC_HOME,    KC_PGDN,   KC_PGUP,   KC_END,     KC_INS,
    KC_LCTL,   KC_LGUI,     KC_LALT,  KC_LSFT,    KC_ALGR,            KC_LEFT,    KC_DOWN,   KC_UP,     KC_RGHT,    KC_APP,
    __x__,     KC_MEH,      __x__,    __x__,      CW_TOGG,            MC_UNDO,    KC_TAB,    MC_COPY,   MC_PASTE,   KC_ENT,
  ...
  [MSEL] = LAYOUT(
    __x__,     __x__,    __x__,     __x__,      __x__,                 KC_WH_L,    KC_WH_D,    KC_WH_U,    KC_WH_R,     KC_INS,
    KC_LCTL,   KC_LGUI,     KC_LALT,  KC_LSFT,    KC_ALGR,             KC_MS_L,    KC_MS_D,    KC_MS_U,    KC_MS_R,     KC_APP,
    __x__,     KC_MEH,    __x__,     __x__,      __x__,                KC_BTN3,      KC_ACL0,    KC_ACL1,    KC_ACL2,     KC_DEL,
                                             TO_BSE, TO_BSE, KC_BTN1, KC_BTN2
  ),
...
const key_override_t psls_key_override =
    ko_make_basic(MOD_MASK_SHIFT, KC_PSLS, KC_PIPE);  // Shift P. is =
const key_override_t astr_key_override =
    ko_make_basic(MOD_MASK_SHIFT, KC_ASTR, KC_BSLS);  // Shift P. is =
